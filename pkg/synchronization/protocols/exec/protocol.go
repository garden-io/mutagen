...
import (
	...
	"github.com/mutagen-io/mutagen/pkg/agent/transports/exec"
...
// connecting to remote endpoints by running a shell command.
...
func init() {
	// Register the TCP protocol handler with the synchronization package.
